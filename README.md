...
Yes, fully. The app is a single self-contained file. Once it's loaded in your browser — or
installed to your home screen — it keeps working with no internet connection.
</details>
...
<details>
<summary><strong>Is any of this medical advice?</strong></summary>
...
Study Suite and its packs are **educational material for exam preparation only** — not medical
advice, and never a basis for decisions about real patients. It's in beta, so content can contain
errors or go out of date. Always check against your own curriculum and trusted sources.

## License

Copyright © 2026 Alkarim Billawala. All rights reserved. The app, its design, and the pack format
are made available for personal study use; they may not be copied, modified, redistributed, or
commercially used without prior written permission (see [LICENSE.txt](LICENSE.txt)). Content you
bring into the app is your own.

---

Built by Alkarim Billawala · [alkarim.billawala.ca](https://alkarim.billawala.ca)
